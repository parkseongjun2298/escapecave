...
#include "ObjMgr.h"
#include "Player.h"
CPlayer_front2::CPlayer_front2(GLuint* _shader_program)
	:CObj(_shader_program)
{
	Initialize();
}

CPlayer_front2::~CPlayer_front2()
{
}

void CPlayer_front2::Initialize()
{
	...
	CObj* pPlayer = CObjectMgr::Get_Instance()->GetPlayer2();
	if (pPlayer)
		object.model_transform.Parent = &pPlayer->Get_Object().model_transform;
}

int CPlayer_front2::Update()
{
	object.model_transform.Rotate.z += 5.f;
	return 0;
}

void CPlayer_front2::Late_Update()
{
}

void CPlayer_front2::Draw()
{
...
void CPlayer_front2::Release()
{
}

void CPlayer_front2::Set_ModelTransform()
{
}
