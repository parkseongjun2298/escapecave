...
//void Server::Send_GameOver()
//{
//	CMainGame maingame;
//	// 조건 걸어서 종료 명령 추가
//	int wave = maingame.Stage_Monster_Wave;
//	if (!CObjectMgr::Get_Instance()->Get_Size(OBJID::PLAYER) || (!CObjectMgr::Get_Instance()->Get_Size(OBJID::BOSS)) && wave == 4 )
//	{
//		datainfo.infoindex = 'z';
//
//		// 통신용 구조체 송신
//		for (int i = 0; i < PLAYERN; i++) {
//			datainfo.datasize = i;
