...
#include "ObjMgr.h"
#include "Player.h"
CPlayer_front3::CPlayer_front3(GLuint* _shader_program)
	:CObj(_shader_program)
{
	Initialize();
}

CPlayer_front3::~CPlayer_front3()
{
}

void CPlayer_front3::Initialize()
{
	...
	CObj* pPlayer = CObjectMgr::Get_Instance()->GetPlayer3();
	if (pPlayer)
		object.model_transform.Parent = &pPlayer->Get_Object().model_transform;
}

int CPlayer_front3::Update()
{
	object.model_transform.Rotate.z += 5.f;
	return 0;
}

void CPlayer_front3::Late_Update()
{
}

void CPlayer_front3::Draw()
{
...
void CPlayer_front3::Release()
{
}

void CPlayer_front3::Set_ModelTransform()
{
}
